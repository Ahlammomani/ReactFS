    ...
    <div className="min-h-screen flex items-center justify-center bg-[#EDE8DC] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md w-full p-8 bg-white rounded-2xl shadow-2xl">
        ...
        <div className="mb-8 relative">
          <div className="absolute -top-6 -left-6 w-24 h-24 bg-[#A5B68D] rounded-full opacity-20"></div>
          <h2 className="text-3xl font-bold text-[#A5B68D] relative z-10">Create Account</h2>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div className="space-y-2">
            ...
            <input 
              className="w-full p-3 bg-[#EDE8DC] bg-opacity-30 border border-[#E7CCCC] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#A5B68D] transition" 
              type="text" 
