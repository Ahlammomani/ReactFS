...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#EDE8DC] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 right-0 w-32 h-64 bg-[#A5B68D] rounded-l-full opacity-30 transform -translate-y-1/2"></div>
      ...
      <div className="absolute top-2/3 left-20 w-8 h-8 rounded-full bg-[#A5B68D] opacity-20"></div>
      ...
      <div className="relative z-10 max-w-md w-full p-8 bg-white rounded-2xl shadow-2xl">
        ...
        <div className="mb-8 relative">
          ...
          <h2 className="text-3xl font-bold text-[#A5B68D] relative z-10">Welcome Back</h2>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div className="space-y-2">
            ...
            <div className="relative">
              <input 
                className="w-full p-3 pl-10 bg-[#EDE8DC] bg-opacity-30 border border-[#E7CCCC] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#A5B68D] transition" 
                type="email" 
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <a href="/forgot-password" className="text-xs text-[#A5B68D] hover:underline">Forgot password?</a>
            </div>
            <div className="relative">
              <input 
                className="w-full p-3 pl-10 bg-[#EDE8DC] bg-opacity-30 border border-[#E7CCCC] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#A5B68D] transition" 
          ...
          <div className="pt-2">
            <button 
              type="submit" 
              className="w-full p-3 bg-[#A5B68D] text-white font-medium rounded-lg shadow-lg hover:bg-[#C1CFA1] transform hover:-translate-y-1 transition-all duration-300"
            >
              Sign In
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button type="button" className="flex items-center justify-center p-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
              <svg className="h-5 w-5 text-[#A5B68D]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-4 text-center text-sm text-gray-600">
            ...
            <a href="/signup" className="ml-1 text-[#A5B68D] hover:underline">
              Sign Up
            </a>
          </div>
        </form>
        ...
        <div className="absolute -bottom-4 left-12 w-32 h-8 bg-[#A5B68D] rounded-t-full opacity-50"></div>
      </div>
    </div>
  );
};
